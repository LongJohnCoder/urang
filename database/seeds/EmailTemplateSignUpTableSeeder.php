...
class EmailTemplateSignUpTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        if(!$has_elements)
        {
        	...
        	$sign_email->first_writeup = "Thank you for signing up with U-Rang.com. We appreciate your business. Please feel free to reach out to us with any additional questions or concerns. We can be reached via email at Lisa@u-rang.com or by phone at (800)959-5785.";
        	$sign_email->image_link = "https://media-cdn.tripadvisor.com/media/photo-s/03/9b/2d/f2/new-york-city.jpg";
        	$sign_email->login_link = "http://u-rang.tier5-portfolio.com/login";
        	$sign_email->website_link = "http://u-rang.tier5-portfolio.com/";
